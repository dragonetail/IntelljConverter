...
public class ToModelTemplate extends PostfixTemplateWithExpressionSelector {

    public ToModelTemplate() {
        super(
                "tomodel",
                "set...",
    ...
    private String getSetsText(String objName, @NotNull PsiField... paramentFields) {
        ...
        for (PsiField field : paramentFields) {
            ...
            builder.append(objName + ".set" + getFirstUpperCase(field.getName()) + "(dto" +
...
//        boolean isInheritor = containingClass.isInheritor(targetClass, true);
//        if (isInheritor) {
//            String classNname = containingClass.getName();
//
//            return getFirstLowerCase(classNname) + "Converter.toModel(dto)";
//        }
